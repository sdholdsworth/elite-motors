...
export const Footer = () => {
    return(
        <footer className="p-2 flex flex-col items-center">
            <nav id="footerNav" className="flex flex-col items-center justify-center gap-y-2 sm:flex-row sm:gap-y-0 sm:gap-x-4 sm:justify-center">
                <NavLink to="/about">About</NavLink>
                <NavLink to="/ratings-and-reviews">Ratings and Reviews</NavLink>
                <NavLink to="/contact">Contact</NavLink>
            </nav>
            <div id="footerLegalInfo" className="flex flex-col items-center my-2">
